...
//////////////////////////////////////////////////////////////////////////////////////
- (id)currentValue {
    NSAssert(NO, @"BMLWorkflowTaskConfigurationOption currentValue called. Should not be here!!");
    return  nil;
}

//////////////////////////////////////////////////////////////////////////////////////
- (void)setCurrentValue:(id)value {
    NSAssert(NO, @"BMLWorkflowTaskConfigurationOption setCurrentValue called. Should not be here!!");
}
